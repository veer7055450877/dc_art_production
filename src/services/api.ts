...
const MOCK_PORTFOLIO: PortfolioItem[] = [
  { id: 1, type: 'photo', src: 'https://images.unsplash.com/photo-1511285560982-1351cdeb9821?q=80&w=2070&auto=format&fit=crop', category: 'Wedding', title: "Royal Union" },
  { id: 2, type: 'photo', src: 'https://images.unsplash.com/photo-1519225448526-0a0295155809?q=80&w=2070&auto=format&fit=crop', category: 'Pre-Wedding', title: "Sunset Love" },
  { id: 3, type: 'photo', src: 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?q=80&w=2070&auto=format&fit=crop', category: 'Wedding', title: "The Vows" },
  { id: 4, type: 'video', src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', poster: 'https://images.unsplash.com/photo-1532712938310-34cb3958d425?q=80&w=2070&auto=format&fit=crop', category: 'Films', title: "Cinematic Highlights", hasAudio: true },
  { id: 5, type: 'photo', src: 'https://images.unsplash.com/photo-1583939411023-147850fe85f0?q=80&w=2070&auto=format&fit=crop', category: 'Details', title: "Golden Details" },
  { id: 6, type: 'photo', src: 'https://images.unsplash.com/photo-1522673607200-1645062cd958?q=80&w=2070&auto=format&fit=crop', category: 'Wedding', title: "Joyful Tears" },
  { id: 7, type: 'photo', src: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?q=80&w=2070&auto=format&fit=crop', category: 'Wedding', title: "Eternal Bond" },
  { id: 8, type: 'video', src: 'https://videos.pexels.com/video-files/3205634/3205634-hd_1920_1080_25fps.mp4', poster: 'https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2070&auto=format&fit=crop', category: 'Films', title: "Silent Emotions", hasAudio: false },
];
